...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a href="{{ route('barang.export_pdf') }}" class="btn btn-sm btn-warning"><i class="fa fa-file-pdf"></i> Export Barang PDF</a>
    ...
    <div id="myModal" class="modal fade animate shake" tabindex="-1" databackdrop="static" data-keyboard="false"
        data-width="75%"></div>
@endsection
